...
.cmn-btn, .feature-section .feature-item .feature-icon i, .feature-section .feature-item.active .feature-icon i, .title-border::before, .title-border::after, .pricing-section .pricing-item:hover .pricing-header .sub-title span, .pricing-section .pricing-item.active .pricing-header .sub-title span, .scrollToTop, .process-icon, .process-area::before, .feature-item::before {
...
<!-- .pricing-section .pricing-item .pricing-header .sub-title span, .preloader, .call-to-action-section{
