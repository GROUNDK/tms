...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'co-owner' => \App\Http\Middleware\RedirectIfNotCoOwner::class,
        'co-owner.guest' => \App\Http\Middleware\RedirectIfCoOwner::class,
        ...
        'counterManager' => \App\Http\Middleware\RedirectIfNotCounterManager::class,
        'counterManager.guest' => \App\Http\Middleware\RedirectIfCounterManager::class,

        'regStatus' => \App\Http\Middleware\AllowRegistration::class,
        'checkStatus' => \App\Http\Middleware\CheckStatus::class,
        'demo' => \App\Http\Middleware\Demo::class,
        'ownerCheckPlan' => \App\Http\Middleware\checkPackage::class,
    ];
}
