...
class ForgotPasswordController extends Controller
{
    ...
    public function showLinkRequestForm()
    {
        ...
        return view('co-owner.auth.passwords.email', compact('page_title'));
    }
    ...
    public function sendResetLinkEmail(Request $request)
    {
        ...
        $user = CoOwner::where('email', $request->email)->first();
        if ($user == null) {
        ...
        return view('co-owner.auth.passwords.code_verify', compact('page_title', 'notify'));
    }
    ...
    public function verifyCode(Request $request)
    {
        ...
        return redirect()->route('co-owner.password.change-link', $code)->withNotify($notify);
    }
}
