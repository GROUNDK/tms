...
class ForgotPasswordController extends Controller
{
    ...
    public function showLinkRequestForm()
    {
        ...
        return view('driver.auth.passwords.email', compact('page_title'));
    }
    ...
    public function sendResetLinkEmail(Request $request)
    {
        ...
        return view('driver.auth.passwords.code_verify', compact('page_title', 'notify'));
    }
    ...
    public function verifyCode(Request $request)
    {
        ...
        return redirect()->route('driver.password.change-link', $code)->withNotify($notify);
    }
}
