...
class SupportTicketController extends Controller
{
    public function tickets()
    {
        ...
        $items = SupportTicket::latest()->with('owner')->paginate(getPaginate());
    ...
    public function pendingTicket()
    {
        ...
        $empty_message = 'No Data found.';
        $items = SupportTicket::whereIn('status', [0,2])->latest()->with('owner')->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'page_title','empty_message'));
    }
    ...
    public function closedTicket()
    {
        ...
        $items = SupportTicket::whereIn('status', [3])->latest()->with('owner')->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'page_title','empty_message'));
    }
    ...
    public function answeredTicket()
    {
        ...
        $empty_message = 'No Data found.';
        $items = SupportTicket::latest()->with('owner')->whereIN('status', [1])->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'page_title','empty_message'));
    }
    ...
    public function ticketReplySend(Request $request, $id)
    {
        ...
        if ($request->replayTicket == 1) {
            ...
            notify($ticket, 'ADMIN_SUPPORT_REPLY', [
                ...
                'link' => route('owner.ticket.view',$ticket->ticket),
            ]);
