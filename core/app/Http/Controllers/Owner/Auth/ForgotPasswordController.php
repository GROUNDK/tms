...
class ForgotPasswordController extends Controller
{
    ...
    public function showLinkRequestForm()
    {
        ...
        return view('owner.auth.passwords.email', compact('page_title'));
    }
    ...
    public function sendResetLinkEmail(Request $request)
    {
        ...
        return view('owner.auth.passwords.code_verify', compact('page_title', 'notify'));
    }
    ...
    public function verifyCode(Request $request)
    {
        ...
        return redirect()->route('owner.password.change-link', $code)->withNotify($notify);
    }
}
