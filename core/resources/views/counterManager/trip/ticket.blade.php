...
.w_ticket .ticket .back .breakleft div, .w_ticket .ticket .back .breakright div {
  width: 12px;
  height: 12px;
  border-radius: 32px;
  border: 3px solid #31124b;
...
.w_ticket .ticket .back .breakcoverleft div, .w_ticket .ticket .back .breakcoverright div {
  width: 0px;
  height: 0px;
  border-radius: 32px;
...
<div  id="block1">
    <div class="w_ticket">
        <div class="ticket">
            ...
            <div class="breakleft"><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>
            <div class="breakcoverleft"><div></div><div></div><div></div><div></div><div></div><div></div></div>
            <div class="breakright"><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>
            <div class="breakcoverright"><div></div><div></div><div></div><div></div><div></div><div></div></div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="print-ticket">
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item d-flex justify-content-between"> @lang('Date of Journey') <span>{{ showDateTime($ticket->date_of_journey, 'F d, Y') }}</span></li>
                                        <li class="list-group-item d-flex justify-content-between"> @lang('Departure  Time') <span>{{ showDateTime($ticket->trip->schedule->starts_from, 'H:i A') }}</span></li>
                                        <li class="list-group-item d-flex justify-content-between"> @lang('Route') <span>{{ $ticket->trip->route->name }}</span></li>
                                        <li class="list-group-item d-flex justify-content-between">@lang('Pickup Point') <span>{{ $ticket->passenger_details['from'] }}</span></li>
                                        <li class="list-group-item d-flex justify-content-between">@lang('Dropping Point') <span>{{ $ticket->passenger_details['to'] }}</span></li>
                                        <li class="list-group-item d-flex justify-content-between">@lang('Passenger Name') <span>{{ $ticket->passenger_details['name'] }}</span></li>
                                        <li class="list-group-item d-flex justify-content-between">@lang('Gender') <span>{{ showGender($ticket->passenger_details['gender']) }}</span></li>

                                        <li class="list-group-item d-flex justify-content-between">@lang('Seats')
                                            <span>
...
<div class="print-btn">
    <button type="button" class="cmn-btn btn-download" id="demo">@lang('Print Ticket')</button>
</div>
