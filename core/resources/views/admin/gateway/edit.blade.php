                            ...
                            <div class="payment-method-header d-flex flex-wrap">
                                ...
                                <div class="content">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="input-group d-flex flex-wrap justify-content-end has_append w-auto">
                            ...
                            @foreach($gateway->currencies as $gateway_currency)
                                ...
                                <div class="payment-method-item child--item">
                                    <div class="payment-method-header d-flex flex-wrap">
                                        <div class="thumb">
                                            <div class="avatar-preview">
                                                <div class="profilePicPreview" style="background-image: url('{{getImage(imagePath()['gateway']['path'].'/'. $gateway_currency->image)}}')"></div>
                                            </div>
                                            <div class="avatar-edit">
