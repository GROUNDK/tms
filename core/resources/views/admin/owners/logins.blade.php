                        ...
                        <table class="table table--light style--two">
                            ...
                            @forelse($login_logs as $log)
                                <tr>
                                    ...
                                    <td data-label="@lang('Username')"><a href="{{ route('admin.users.detail', $log->owner_id)}}"> {{ ($log->owner) ? $log->owner->username : '' }}</a></td>
                                    <td data-label="@lang('IP')">
                                        <a href="{{route('admin.users.login.ipHistory',[$log->owner_ip])}}">
                                            {{ $log->owner_ip }}
                                        </a>
                                    </td>
