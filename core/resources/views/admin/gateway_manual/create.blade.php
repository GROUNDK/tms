                                ...
                                <div class="content">
                                    <div class="row mt-4 mb-none-15">
                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-15">
                                            <label class="font-weight-bold">@lang('Gateway Name') <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-15">
                                            ...
                                            <div class="input-group has_append">
                                                ...
                                                <input type="text" class="form-control" placeholder="@lang('0')" name="rate" value="{{ old('rate') }}"/>
                                        ...
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="min_limit" placeholder="@lang('0')" value="{{ old('min_limit') }}"/>
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="@lang('0')" name="max_limit" value="{{ old('max_limit') }}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="@lang('0')" name="fixed_charge" value="{{ old('fixed_charge') }}"/>
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="@lang('0')" name="percent_charge" value="{{ old('percent_charge') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
