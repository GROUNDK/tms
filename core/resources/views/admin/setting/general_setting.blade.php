                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('Default Package')</label>

                                    <select name="default_package" class="form-control">
                                        <option value="">@lang('No Package')</option>
                                        @foreach ($packages as $package)
                                            <option value="{{ $package->id }}" {{ $general->package_id == $package->id?'selected':'' }}>{{ __($package->name) }}</option>
                                        @endforeach
                                    </select>

                                    <p class="text-danger text--small"> <i class="fas fa-info-circle"></i> @lang('You didn\'t add any package yet.')</p>
                                </div>
                            </div>
                        </div>
...
@push('script-lib')
    <script src="{{ asset('assets/all_vendors/js/spectrum.js') }}"></script>
@endpush

@push('style-lib')
    <link rel="stylesheet" href="{{ asset('assets/all_vendors/css/spectrum.css') }}">
@endpush
