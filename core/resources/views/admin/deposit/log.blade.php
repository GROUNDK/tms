                    ...
                    <table class="table table--light style--two">
                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Owner')"><a href="{{ route('admin.users.detail', $deposit->owner_id??0) }}">{{ @$deposit->owner->username }}</a></td>
                                ...
                                @elseif(request()->routeIs('admin.deposit.list')  || request()->routeIs('admin.deposit.search') || request()->routeIs('admin.users.deposits'))
                                    <td data-label="@lang('Status')">
                                        ...
                                        @elseif($deposit->status == 1)
                                            <span class="badge badge--success font-weight-normal text--samll">@lang('Approved')</span>
