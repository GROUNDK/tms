            ...
            <div class="card b-radius--5 overflow-hidden">
                <div class="card-body p-0">
                    <div class="d-flex p-3 bg--primary">
                        ...
                        <div class="pl-3">
                            <h4 class="text--white">{{$supervisor->name}}</h4>
                        </div>
                    </div>
                    ...
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Owner Name')
                            <span class="font-weight-bold">{{$supervisor->owner->owner_name}}</span>
                        </li>
...
@push('breadcrumb-plugins')
    <a href="{{route('supervisor.profile')}}" class="btn btn-sm btn--primary box--shadow1 text--small" ><i class="fa fa-user"></i>@lang('Profile Setting')</a>
@endpush
