        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('owner.fleet_manage.seat_layout.add', 0) }}" method="POST">
                        @csrf
    ...
    <script>
        ...
        (function($){
            ...
            $(document).on('click', '.edit-btn', function () {
                var modal = $('#editModal');
                var link  = `{{ route('owner.fleet_manage.seat_layout.add', '') }}/${$(this).data('id')}`;
            ...
            $(document).on('click', '.delete-btn', function () {
                ...
                var link  = `{{ route('owner.fleet_manage.seat_layout.remove', '') }}/${id}`;
                modal.find('form').attr('action', link);
                modal.modal('show');
            });
