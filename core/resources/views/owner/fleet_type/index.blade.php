                            ...
                            @forelse($fleet_types as $fleet_type)
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="javascript:void(0)" data-fleet_type="{{ $fleet_type }}"
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="text-right">
                    ...
                    <a href="{{ route('owner.fleet_manage.fleet_type.create') }}" class="close"
                        data-toggle="tooltip" title="@lang('Open in New Page')"><span aria-hidden="true">&#10064;</span></a>
                </div>
            </div>
            <div class="modal-body">
                <form action="{{ route('owner.fleet_manage.fleet_type.store', 0) }}"
                    method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="seat_layout" id="seat_layout">
                            <option selected value="">@lang('Seat Layout')</option>
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                            data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Active')" data-off="@lang('Inactive')"
                            name="status" checked>
                    </div>
    ...
    <script>
        ...
        (function($){
            ...
            $(document).on('click', '.edit-btn', function () {
                ...
                var link        = `{{ route('owner.fleet_manage.fleet_type.store', '') }}/${data.id}`;
                ...
                var elink = `{{ route('owner.fleet_manage.fleet_type.edit','') }}/${data.id}`
