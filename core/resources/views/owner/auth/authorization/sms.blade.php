        ...
        <div class="form-area bg_img" data-background="{{asset('assets/all_vendors/images/1.jpg')}}">
            <div class="form-wrapper">
                    ...
                    <div class="logo-text mb-15">
                        <h5 class="title text-center">@lang('Please verify your mobile to get access')</h5>
                        <p class="text-center">@lang('Your Mobile:') <strong>{{auth()->guard('owner')->user()->mobile}}</strong></p>
                    </div>

                    <form class="cmn-form mt-30" method="post" action="{{route('owner.verify_sms')}}">
                        @csrf
                        ...
                        <p class="mt-3 ">@lang('If not found, you can')
                            <a class="text-danger"
                                href="{{route('owner.send_verify_code')}}?type=email">@lang('Try Again')</a>
                        </p>
