                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="{{route('owner.trip.route.edit', $route->id)}}" class="icon-btn edit-btn" data-toggle="tooltip" data-placement="top" title="@lang('Edit')">
...
@push('breadcrumb-plugins')
    <a href="{{route('owner.trip.route.create')}}" class="btn btn-sm btn--success text--small box--shadow1">
