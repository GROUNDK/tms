                            ...
                            @if(count($logs) >0)
                                @foreach($logs as $k=>$data)
                                    <tr>
                                        ...
                                        <td>
                                            @if($data->status == 1)
                                                <span class="badge font-weight-normal badge--success">@lang('Complete')</span>
                                            @elseif($data->status == 2)
                                                <span class="badge font-weight-normal badge--warning">@lang('Pending')</span>
                                            @elseif($data->status == 3)
                                                <span class="badge font-weight-normal badge--danger">@lang('Cancel')</span>
                                            @endif
                                        ...
                                        <td data-label="@lang('Details')">
                                            <a href="javascript:void(0)" class="icon-btn btn--primary btn-sm approveBtn"
                                               data-info="{{$details}}"
                                               data-id="{{ $data->id }}"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between">@lang('Amount') : <span class="withdraw-amount "></span></li>
                        <li class="list-group-item d-flex justify-content-between">@lang('Charge') : <span class="withdraw-charge "></span></li>
                        <li class="list-group-item d-flex justify-content-between">@lang('After Charge') : <span class="withdraw-after_charge"></span></li>
                        <li class="list-group-item d-flex justify-content-between">@lang('Conversion Rate') : <span class="withdraw-rate"></span></li>
                        <li class="list-group-item d-flex justify-content-between">@lang('Payable Amount') : <span class="withdraw-payable"></span></li>
                    </ul>
