                ...
                <div class="card card-deposit">
                    ...
                    <div class="card-body card-body-deposit">
                        ...
                        <form role="form" id="payment-form" method="{{$data->method}}" action="{{$data->url}}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <span class="input-group-text bg--dark"><i class="fa fa-font"></i></span>
                                        </div>
                                    </div>
                            ...
                            <br>
                            <button class="btn btn--dark btn--capsule btn-lg btn-block text-center" type="submit"> @lang('PAY NOW')
                            </button>
