                    ...
                    <div class="table-responsive--md table-responsive">
                        <table class="default-data-table table table-striped">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Name')" data-toggle="tooltip" data-placement="top" title="{{ $counter->location }}">{{$counter->name}}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('owner.counter.store', 0) }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="counter_manager">@lang('Counter Managers')</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            <label for="edit-counter_manager">@lang('Counter Managers')</label>
    ...
    <script>
        ...
        (function($){
            $(document).on('click', '.edit-btn', function () {
                ...
                var link  = `{{ route('owner.counter.store', '') }}/${data.id}`;
