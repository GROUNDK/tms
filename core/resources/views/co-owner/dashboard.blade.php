        ...
        <div class="row mb-none-30">
            <div class="col-xl-3 col-md-6 mb-30">
                <div class="widget bb--3 border--success b-radius--10 bg--white p-4 box--shadow2 has--link">
                    <a href="{{ route('co-owner.fleet_manage.bus') }}" class="item--link"></a>
            ...
            <div class="col-xl-3 col-md-6 mb-30">
                <div class="widget bb--3 border--primary b-radius--10 bg--white p-4 box--shadow2 has--link">
                    <a href="{{ route('co-owner.driver.index') }}" class="item--link"></a>
            ...
            <div class="col-xl-3 col-md-6 mb-30">
                <div class="widget bb--3 border--info b-radius--10 bg--white p-4 box--shadow2 has--link">
                    <a href="{{ route('co-owner.supervisor.index') }}" class="item--link"></a>
            ...
            <div class="col-xl-3 col-md-6 mb-30">
                <div class="widget bb--3 border--indigo b-radius--10 bg--white p-4 box--shadow2 has--link">
                    ...
                    <div class="widget__content">
                        <p class="text-uppercase text-muted">@lang('Total Co-Owners')</p>
            ...
            <div class="col-xl-3 col-md-6 mb-30">
                <div class="widget bb--3 border--indigo b-radius--10 bg--white p-4 box--shadow2 has--link">
                    <a href="{{ route('co-owner.counter.index') }}" class="item--link"></a>
            ...
            <div class="col-xl-3 col-md-6 mb-30">
                <div class="widget bb--3 border--info b-radius--10 bg--white p-4 box--shadow2 has--link">
                    <a href="{{ route('co-owner.counter_manager.index') }}" class="item--link"></a>
            ...
            <div class="col-xl-3 col-md-6 mb-30">
                <div class="widget bb--3 border--primary b-radius--10 bg--white p-4 box--shadow2 has--link">
                    <a href="{{ route('co-owner.trip.route') }}" class="item--link"></a>
            ...
            <div class="col-xl-3 col-md-6 mb-30">
                <div class="widget bb--3 border--success b-radius--10 bg--white p-4 box--shadow2 has--link">
                    <a href="{{ route('co-owner.trip.index') }}" class="item--link"></a>
