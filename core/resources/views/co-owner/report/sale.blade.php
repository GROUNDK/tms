                            ...
                            @forelse($sales as $sale)
                                <tr>
                                    ...
                                    <td data-label="@lang('View')">
                                        <a href="{{ route('co-owner.report.sale.detail', $sale->id) }}" class="icon-btn btn--primary"><i class="la la-desktop"></i></a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
    ...
    <div class="modal fade" id="modelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('co-owner.report.sale.filter') }}" method="POST">
                    @csrf
...
@if(request()->routeIs('co-owner.report.sale.filtered'))
<a href="{{ route('co-owner.report.sale') }}" class="btn btn--dark btn--shadow mr-1 filter-btn"><i class="la la-reply"></i> @lang('Back') </a>
@else
        ...
        <div class="input-group has_append">
            ...
            <div class="input-group-append">
                ...
                @if(request()->has('search'))
                    <a href="{{ route('co-owner.report.sale') }}" class="btn btn--dark rounded-right ">
                        @lang('Clear')
                    </a>
                @endif
            </div>
