...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('co-owner.trip.store', $trip->id??0) }}" method="POST">
                        ...
                        <div class="from-to-wrapper">
                            @if(request()->routeIs('co-owner.trip.edit'))
                            <div class="form-group">
...
<div class="row d-flex flex-row-reverse">
    <a href="{{route('co-owner.trip.index')}}" class="btn btn-sm btn--dark"><i class="la la-reply"></i>@lang('Back')</a>
</div>
@endpush
