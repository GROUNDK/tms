...
@section('panel')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('co-owner.trip.route.store', $route->id??0) }}" method="POST">
                        @csrf
                        ...
                        <div class="stoppages-wrapper">
                            @if(request()->routeIs('co-owner.trip.route.edit'))
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="time" value="{{$route->distance??null}}" id="time" class="form-control" placeholder="@lang('3 Hour')"/>
                            <small class="text-danger">@lang('Keep SPACE between value and unit')</small>
                        </div>
                        <div class="row">
...
@push('breadcrumb-plugins')
    <a href="{{route('co-owner.trip.route')}}" class="btn btn-sm btn--dark text--small box--shadow1"><i class="las la-reply"></i>@lang('Back')</a>
@endpush
