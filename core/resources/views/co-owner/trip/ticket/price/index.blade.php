                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{route('co-owner.trip.ticket.price.edit', $tp->id)}}" data-trip="{{ $tp }}" class="icon-btn edit-btn" data-toggle="tooltip" data-placement="top" title="@lang('Edit')">
...
<div class="row d-flex flex-row-reverse p-2">
    <div class="px-1 col-xl-3 col-lg-12 mb-2 mb-xl-0">
        @if(request()->routeIs('co-owner.trip.ticket.price'))
        <a  href="{{route('co-owner.trip.ticket.price.create')}}" class="btn btn--success mr-1 mb-2 mb-xl-0 add-btn text--small"><i class="la la-plus"></i> @lang('Add New')</a>
        @else
            <a href="{{route('co-owner.trip.ticket.price')}}" class="btn btn-dark"><i class="la la-reply"></i>@lang('Back')</a>
        @endif
    </div>
</div>
@endpush
    ...
    <script>
        ...
        (function($){
            $(document).on('click', '.delete-btn', function () {
                ...
                var id      = $(this).data('id');
                var link  = `{{ route('co-owner.trip.ticket.price.remove', '') }}/${id}`;
