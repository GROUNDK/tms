...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('co-owner.counter_manager.store', $counter_manager->id??0) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            @if(!request()->routeIs('co-owner.counter_manager.edit'))
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="address" id="address" rows="3" placeholder="@lang('Type Address Here')">{{$counter_manager->address??null}}</textarea>
                                </div>
                            </div>
...
<a href="{{route('co-owner.counter_manager.index')}}" class="btn btn-sm btn--dark text--small box--shadow1"><i class="las la-reply"></i> @lang('Back')</a>
@endpush
