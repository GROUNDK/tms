...
@section('panel')
                            ...
                            <tr>
                               ...
                               <td data-label="@lang('Name')">
                                ...
                                <td data-label="@lang('Action')">
                                    ...
                                    <a href="javascript:void(0)" data-id="{{ $counter_manager->id }}" class="ml-1 icon-btn btn--danger delete-btn" data-toggle="tooltip" data-placement="top" title="Delete">
    ...
    @if(request()->routeIs('co-owner.counter_manager.index'))
        <div id="addModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">@lang('Add Counter Manager')</h5>
                        <div class="text-right">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" data-toggle="tooltip" title="@lang('Close')">
                                <span aria-hidden="true">&times;</span>
                            </button>
                            <a href="{{route('co-owner.counter_manager.create')}}" class="close" data-toggle="tooltip" title="@lang("Open in New Page")"><span aria-hidden="true">&#10064;</span></a>
                        </div>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('co-owner.counter_manager.store', 0) }}" method="POST">
                            @csrf
    ...
    <script>
        ...
        (function($){
            ...
            $(document).on('click', '.edit-btn', function () {
                ...
                var link  = `{{ route('co-owner.counter_manager.store', '') }}/${data.id}`;
                ...
                var elink = `{{route('co-owner.counter_manager.edit','')}}/${data.id}`
            ...
            $(document).on('click', '.delete-btn', function () {
                ...
                var id  = $(this).data('id');
                var link  = `{{ route('co-owner.counter_manager.remove', '') }}/${id}`;
                modal.find('form').attr('action', link);
                modal.modal('show');
            });
