...
<div class="row">
    <div class="col-lg-12">
        <div class="card b-radius--10 ">
            <div class="card-body">
                <form action="{{ route('co-owner.fleet_manage.fleet_type.store', $fleet_type->id??0) }}"
                    method="POST">
                    @csrf
                    ...
                    <div class="seat-number-wrapper">
                        @if(request()->routeIs('co-owner.fleet_manage.fleet_type.edit'))
                        <div class="row">
...
@push('breadcrumb-plugins')
    <a href="{{ route('co-owner.fleet_manage.fleet_type') }}" class="btn btn--dark">
