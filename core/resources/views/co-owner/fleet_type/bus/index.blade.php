                        ...
                        <tbody>
                            @forelse($buses as $bus)
                                <tr>
                                    ...
                                    <td data-label="@lang('Fleet Type')">{{ $bus->fleetType->name}} - {{ $bus->fleetType->total_seat }} ({{ $bus->fleetType->has_ac? trans('AC'): trans('Non AC') }})</td>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="javascript:void(0)" data-bus="{{ $bus }}" class="icon-btn edit-btn" data-toggle="tooltip" data-placement="top" title="@lang('Edit')">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="text-right">
                    ...
                    <a href="{{ route('co-owner.fleet_manage.bus.create') }}" class="close" data-toggle="tooltip" title="@lang('Open in New Page')"><span aria-hidden="true">&#10064;</span></a>
                </div>
            </div>
            <div class="modal-body">
                <form action="{{ route('co-owner.fleet_manage.bus.store', 0) }}" method="POST">
                    @csrf
    ...
    <script>
        ...
        (function($){
            $(document).on('click', '.edit-btn', function () {
                ...
                var link    = `{{ route('co-owner.fleet_manage.bus.store', '') }}/${data.id}`;
                ...
                var elink = `{{ route('co-owner.fleet_manage.bus.edit','') }}/${data.id}`
