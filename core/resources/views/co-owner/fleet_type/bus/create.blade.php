...
<div class="row">
    <div class="col-lg-12">
        <div class="card b-radius--10 ">
            <div class="card-body">
                <form action="{{ route('co-owner.fleet_manage.bus.store', $bus->id??0) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
...
@push('breadcrumb-plugins')
    <a href="{{ route('co-owner.fleet_manage.bus') }}" class="btn btn-sm btn--dark box--shadow1 text--small">
