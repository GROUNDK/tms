            ...
            <li class="dropdown">
                <button type="button"  data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="navbar-user">
                        <span class="navbar-user__thumb"><img src="{{ getImage('assets/owner/images/driver/'. auth()->guard('driver')->user()->image, true) }}" alt="image"></span>

                        <span class="navbar-user__info">
                        <span class="navbar-user__name">{{auth()->guard('driver')->user()->username}}</span>
                        </span>
