    ...
    <div class="page-wrapper default-version">
        <div class="form-area bg_img" data-background="{{asset('assets/all_vendors/images/1.jpg')}}">
            <div class="form-wrapper">
                <h4 class="logo-text mb-15"> @lang("Welcome to $general->sitename")</strong></h4>
                <p>@lang("$page_title to $general->sitename dashboard")</p>

                <form action="{{ route('driver.loginSubmit') }}" method="POST" class="cmn-form mt-30">
                    @csrf
                    ...
                    <div class="form-group d-flex justify-content-between align-items-center">
                        <a href="{{ route('driver.password.reset') }}" class="text-muted text--small">
                            <i class="las la-question-circle"></i></i>@lang('Forgot password?')
                        </a>
                    </div>
